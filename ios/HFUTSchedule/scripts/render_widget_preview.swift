...
private func sampleData() -> WeeklyScheduleViewData {
    ...
    return WeeklyScheduleViewData(
        ...
        monday: monday,
        courses: [
            course("高等数学A（上）", "李慧民", "翠五教304", 1, "08:00", "09:40", 0),
            course("程序设计基础", "杨静", "翠十二教106", 1, "10:00", "11:40", 1),
            course("高等数学A（上）", "李慧民", "翠五教304", 2, "10:00", "11:40", 0),
            course("思想道德与法治", "江刚", "翠五教304", 2, "14:00", "15:40", 4),
            course("线性代数", "檀敬东", "翠三教101", 3, "10:00", "11:40", 1),
            course("程序设计基础", "杨静", "翠十二教106", 4, "10:00", "11:40", 3),
            course("大学生心理健康", "胡倩倩", "翠四教112", 4, "14:00", "15:40", 2),
            course("大学体育（1）", "童彦章", "体育场", 4, "15:50", "17:30", 0),
            course("线性代数", "檀敬东", "翠三教101", 5, "08:00", "09:40", 3),
            course("高等数学A（上）", "李慧民", "翠五教304", 5, "10:00", "11:40", 1),
            course("思想道德与法治", "江刚", "翠五教304", 5, "15:50", "17:30", 0)
        ]
    )
}
